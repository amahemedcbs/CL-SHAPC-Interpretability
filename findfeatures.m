function [result] = findfeatures(ingresso,dctlength,do_dct)
%--------------------------------------------------------------------
%
...
% While the scanned area is less than the total area
while cont<dimprod
...
if ~exist('do_flatten','var')
        do_flatten = true;
end

%disp("do_dct: " + string(do_dct))
if do_dct == true
    t                = dct2(ingresso);
else
    t                = ingresso;
