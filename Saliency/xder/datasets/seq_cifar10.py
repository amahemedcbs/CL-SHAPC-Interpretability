...
from Saliency.xder.utils.conf import base_path
from Saliency.xder.datasets.transforms.denormalization import DeNormalize
from Saliency.xder.datasets.utils.continual_dataset import (ContinualDataset, fix_class_names_order,
                                              store_masked_loaders)
from Saliency.xder.datasets.utils import set_default_from_args
...
class SequentialCIFAR10(ContinualDataset):
    ...
    def get_data_loaders(self) -> Tuple[torch.utils.data.DataLoader, torch.utils.data.DataLoader]:
        ...
        train_dataset = MyCIFAR10(base_path("../../Datasets") + 'cifar10', train=True,
                                  download=True, transform=transform)
        test_dataset = TCIFAR10(base_path("../../Datasets") + 'cifar10', train=False,
