...
from models.xder.utils import infer_args_from_signature, register_dynamic_module_fn
from models.xder.utils.conf import warn_once
...
for file in os.listdir(os.path.dirname(__file__)):
    if file.endswith('.py') and file != '__init__.py':
        importlib.import_module(f'models.xder.datasets.{file[:-3]}')
